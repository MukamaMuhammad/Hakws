  ...
  return (
    <section className="text-gray-600 body-font relative mt-10">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10  p-10 flex items-end max-md:items-center justify-start max-md:justify-center relative max-md:mr-0">
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="mt-1">
                Kisaasi, Ntinda Road. Kampala Opp Ndere Cultural Gardens
              </p>
            </div>
