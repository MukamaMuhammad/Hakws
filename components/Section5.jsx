          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <p className="leading-relaxed mb-6">
                ...
                dream home into a reality, and we couldn't be happier with the
                results. Hawks is the go-to choice for anyone looking for
          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <p className="leading-relaxed mb-6">
                ...
                smoothly. Our new office space is not only functional but also
                an impressive work of architecture. Thanks to Hawks, our
                business has a new home that speaks of success.
              </p>
              <a className="inline-flex items-center">
                <Image
                  alt="testimonial"
